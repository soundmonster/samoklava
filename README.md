...
## Warning
I'm currently updating this design to the latest version of [Ergogen](https://github.com/mrzealot/ergogen/). Mounting
holes are off. Stay tuned. If you absolutely want to build this, use the gerber files from the latest release.
